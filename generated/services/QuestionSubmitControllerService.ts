...
import type { BaseResponse_JudgeResultResponse_ } from "../models/BaseResponse_JudgeResultResponse_";
...
export class QuestionSubmitControllerService {
   ...
   * @returns BaseResponse_JudgeResultResponse_ OK
   * @returns any Created
   * @throws ApiError
   */
  public static addQuestionSubmitUsingPost(
    questionSubmitAddRequest: QuestionSubmitAddRequest
  ): CancelablePromise<BaseResponse_JudgeResultResponse_ | any> {
  ...
  public static listMyQuestionSubmitVoByPageUsingPost(
    ...
    return __request(OpenAPI, {
      method: "POST",
      url: "/api/submit/my/list/page/vo",
      body: questionSubmitQueryRequest,
      errors: {
        401: `Unauthorized`,
        403: `Forbidden`,
